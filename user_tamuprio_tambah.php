...
if($_SERVER['REQUEST_METHOD']==='POST') {
  ...
  $ok = $db->query(
    "INSERT INTO tamu_prio (name,kategori) VALUES ('$nama','$kategori')"
  );
      ...
      <header class="bg-white shadow-sm z-10">
        <div class="flex items-center justify-between p-4">
          <div class="flex items-center md:hidden">
            <button id="menuToggle" class="w-10 h-10 flex items-center justify-center text-gray-600">
              <i class="ri-menu-line ri-lg"></i>
            </button>
            <h1 class="text-xl font-['Pacifico'] text-primary ml-2">SIKAT</h1>
          </div>
        </div>
