...
<div class="flex h-screen overflow-hidden">
  ...
  <main class="flex-1 overflow-y-auto p-6">
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-xl font-bold text-gray-800">Data Keperluan Kunjungan</h1>
      ...
      <table class="w-full text-sm">
        ...
        <tbody>
          ...
          <tr class="border-b">
            ...
            <td class="px-4 py-2">
              <button onclick="editKeperluan(<?= $row['id'] ?>, '<?= addslashes($row['nama']) ?>')" class="text-blue-500">Edit</button>
...
<div id="modalTambah" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center hidden">
  <form method="POST" class="bg-white p-6 rounded-md w-96">
    <h2 class="text-lg font-semibold mb-4">Tambah Keperluan</h2>
...
<div id="modalEdit" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center hidden">
  <form method="POST" class="bg-white p-6 rounded-md w-96">
    ...
    <h2 class="text-lg font-semibold mb-4">Edit Keperluan</h2>
